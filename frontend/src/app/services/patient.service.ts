...
export class PatientService {
  ...
  async fetchPatientDetails(token: string, id: string): Promise<PatientDetail[]> {
  ...
  async savePatientDetail(token: string, patientDetail: Partial<PatientDetail>, patientId: string): Promise<void> {
